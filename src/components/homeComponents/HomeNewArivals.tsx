        ...
        <div className='w-full h-full xl:px-40 lg:px-20 md:px-16 px-5 py-10'>
            <div className='flex justify-between items-center'>
                <div className='space-y-4'>
                    <h1 className='md:text-5xl text-3xl font-extrabold'>New Arrivals</h1>
                    <p className='text-[rgb(89,80,83)] md:text-base text-sm'>Be the first to wear this season’s latest looks. Handpicked and <span><br /></span> freshly styled.</p>
                </div>
                <div>
                    <button
                        className='md:px-6 md:py-3 px-2 py-2 border rounded-3xl md:text-base text-xs font-semibold 
                border-[rgb(239,35,60)] text-[rgb(239,35,60)]
                 hover:bg-[rgb(239,35,60)] hover:text-white uppercase'
                    >
                        See What's New
                    </button>
                </div>
            </div>
            <div className='grid md:grid-cols-3 grid-cols-2 gap-6 mb-20 mt-4'>{products.map((product, index) => (
                <div className=''>
                    <ul key={index}>
                    ...
                    <div className='space-y-2 mt-4'>
                        ...
                        <label className='flex md:justify-baseline justify-start items-center gap-2'>{product.colors.map((color, inx) => (
